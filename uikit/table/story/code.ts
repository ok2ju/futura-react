export const code = `import { useMemo } from 'react';
...
export const anatomy = `import * as TablePrimitive from '@futura-react/table';

() => (
  <TablePrimitive.Table>
    <TablePrimitive.TableHead>
      <TablePrimitive.TableHeadRow>
        <TablePrimitive.TableHeadCell>...</TablePrimitive.TableHeadCell>
      </TablePrimitive.TableHeadRow>
    </TablePrimitive.TableHead>
    <TablePrimitive.TableBody>
      <TablePrimitive.TableRow>
        <TablePrimitive.TableCell>...</TablePrimitive.TableCell>
      </TablePrimitive.TableRow>
    </TablePrimitive.TableBody>
  </TablePrimitive.Table>
);`;
